...
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/leaf02/interfaces
cp interfaces /etc/network/interfaces
echo "  copying daemons"
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/leaf02/daemons
cp daemons /etc/quagga/daemons
echo "  copying Quagga.conf"
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/leaf02/Quagga.conf
