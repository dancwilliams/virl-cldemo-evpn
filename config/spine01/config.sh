...
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/spine01/interfaces
cp interfaces /etc/network/interfaces
echo "  copying daemons"
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/spine01/daemons
cp daemons /etc/quagga/daemons
echo "  copying Quagga.conf"
wget https://raw.githubusercontent.com/dancwilliams/virl-cldemo-evpn/master/config/spine01/Quagga.conf
